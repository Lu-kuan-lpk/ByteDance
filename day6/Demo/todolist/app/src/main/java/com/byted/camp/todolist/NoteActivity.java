...
public class NoteActivity extends AppCompatActivity {
    ...
    private boolean saveNote2Database(String content, Priority priority) {
        ...
        values.put(todoentry.COLUMN_STATE, State.TODO.intValue);
        values.put(todoentry.COLUMN_DATE, System.currentTimeMillis());
        values.put(todoentry.COLUMN_PRIORITY, priority.intValue);
